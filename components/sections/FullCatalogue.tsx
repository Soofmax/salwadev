...
const generateCatalogueStructuredData = (
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: generateCatalogueStructuredData(
            filteredServices,
            activeFilter
          ),
        }}
      ...
      <div className="w-full">
        ...
        <div className="text-center mb-8">
          <p className="text-lg text-charcoal/70">
            ...
            {catalogueStats.priceRange && (
              <>
                {' '}
                • De <strong>{catalogueStats.priceRange.min}€</strong> à{' '}
                <strong>{catalogueStats.priceRange.max}€</strong>
              </>
            )}
            {activeFilter !== 'tous' && (
              <>
                ...
                dans la catégorie{' '}
                <strong>
                  {serviceCategories.find((c) => c.id === activeFilter)?.name}
                </strong>
              </>
            )}
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between max-w-6xl mx-auto">
            ...
            <div className="relative w-full lg:w-2/5">
              ...
              <p id="search-help" className="sr-only">
                Recherchez par nom de service, description, fonctionnalité ou
                prix
              </p>
            </div>
          ...
          <div className="mt-6 max-w-6xl mx-auto">
            ...
            >
              <h4 id="filter-heading" className="sr-only">
                Filtres de catégories de services
              </h4>
          ...
          {filteredServices.length > 0 ? (
            ...
            >
              {filteredServices.map((service, index) => (
                <article
                  ...
                  className={
                    viewMode === 'list'
                      ? 'bg-white rounded-xl p-6 border border-rose-powder/30 hover:border-magenta/30 transition-all'
                      : ''
                  }
                >
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-rose-powder/20">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                <p className="text-sm text-charcoal/50 w-full mb-3">
                  Suggestions :
                </p>
                {['SEO', 'E-commerce', 'IA', 'Site vitrine', 'Mobile'].map(
                  (suggestion) => (
                    <button
                      key={suggestion}
        ...
        <footer className="mt-16 pt-8 border-t border-rose-powder/20 text-center">
          <p className="text-sm text-charcoal/60">
            Catalogue mis à jour régulièrement • {allServices.length} services
            disponibles • Devis gratuit sous 24h
          </p>
        </footer>
      </div>
    </>
