      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-charcoal/70 leading-relaxed">
            Commencez par une base solide et ajoutez les options qui
            correspondent à vos besoins. Chaque projet est unique, comme vous.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-rose-powder/20 to-magenta/10 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
              Votre projet nécessite une approche unique ? Discutons ensemble de
              vos besoins spécifiques pour créer la solution parfaite.
            </p>
            <Link href="/contact">
              <Button
                size="lg"
