    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-start gap-3">
          <Cookie
            className="w-8 h-8 text-rose-powder flex-shrink-0 mt-1"
            aria-hidden="true"
          />
          <div>
            <h3
            ...
            <p
              ...
              className="text-sm text-cream/80 mt-1"
            >
              Nous utilisons des cookies pour analyser le trafic et améliorer
              votre expérience. Votre confiance est essentielle.{' '}
              <Link
                href="/privacy"
                className="underline hover:text-rose-powder"
              >
                En savoir plus
              </Link>
              .
