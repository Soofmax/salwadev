    ...
    <section className="py-20 bg-charcoal relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 animate-float">
          <Sparkles className="w-8 h-8 text-rose-powder" />
        </div>
        <div
        ...
        >
          <Sparkles className="w-7 h-7 text-rose-powder" />
        </div>
        <div
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-cream/80 leading-relaxed mb-8 max-w-3xl mx-auto">
            Chaque projet est une nouvelle aventure créative. Parlons de vos
            ambitions et créons ensemble quelque chose d'extraordinaire qui vous
            ressemble vraiment.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-cream/70 text-sm leading-relaxed">
                Chaque élément est pensé spécialement pour votre marque et vos
                objectifs
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-cream/70 text-sm leading-relaxed">
                Projets livrés en 3 à 10 jours selon la complexité, sans
            ...
            <div className="text-center">
              ...
              <p className="text-cream/70 text-sm leading-relaxed">
                Accompagnement personnalisé jusqu'à ce que votre projet soit
                parfait
              </p>
            </div>
          </div>
